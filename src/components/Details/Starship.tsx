	...
	return (
		<>
			<Separator>Spaceship</Separator>
				...
				<div className='flex flex-col lg:flex-row-reverse mt-6 mx-12 md:mx-24 gap-1 p-1 bg-yellow-500 justify-items-center justify-center'>
			<img className="w-full shrink lg:basis-[1200px] object-cover bg-stone-950 " src={id} onError={addFallbackImg} alt={id} />
			<div className="w-full flex-1 min-w-[50%] grid md:grid-cols-2 div-grid bg-stone-950 md:p-10 p-7 shadow-sm gap-4">
